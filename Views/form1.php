...
<body>
    ...
    <div id="main">
            <div class="form">
                <form action="index.php?action=pdf1" method="post">
                <h1>Formulaire</h1>
                <span>  <?php if(isset($variables["erreur"]["a"])) {$err = $variables["erreur"]["a"]; echo $err; echo"<br>"; } else " " ; ?></span>
                    <input placeholder="Nom" type="text" name="nom">
                    <input placeholder="Prenom" type="text" name="prenom">
                    <input placeholder="Matricule" type="text" name="matricule">
                    <input placeholder="Grade" type="text" name="grade">
                    <input placeholder="Echelle" type="text" name="echelle">
                    <input placeholder="Echelon" type="text" name="echelon">
                    <input placeholder="Telephone" type="tel" name="tele">
                    <input placeholder="Diplome" type="text"name="diplome">
                    <input placeholder="Etablissement" type="text" name="etablissement"><br>
